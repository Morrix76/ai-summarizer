  ...
  return (
    <div className="glass-card p-6">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="text-white font-semibold text-lg">Le Tue Statistiche</h3>
      </div>
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="text-center">
          ...
          <div className="text-white/60 text-sm">Riassunti</div>
        </div>
        ...
        <div className="text-center">
          ...
          <div className="text-white/60 text-sm">Parole</div>
        </div>
        ...
        <div className="text-center">
          ...
          <div className="text-white/60 text-sm">Caratteri</div>
        </div>
      </div>

      {stats.totalSummaries === 0 && (
        <div className="mt-4 text-white/40 text-xs text-center">
          Le statistiche vengono salvate localmente nel tuo browser
        </div>
      )}
    </div>
  )
