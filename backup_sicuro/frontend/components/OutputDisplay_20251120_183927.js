    ...
    <div className="space-y-4 animate-slide-up">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <h3 className="text-white font-semibold text-lg">{t('output.title')}</h3>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <div className="glass-card p-3">
          <div className="text-white/50 text-xs mb-1">{t('output.stats.words')}</div>
          <div className="text-white font-semibold text-lg">{wordCount}</div>
        </div>
        <div className="glass-card p-3">
          <div className="text-white/50 text-xs mb-1">{t('output.stats.characters')}</div>
          <div className="text-white font-semibold text-lg">
            {metadata.summaryLength?.toLocaleString() || 'N/A'}
          </div>
        </div>
        <div className="glass-card p-3">
          <div className="text-white/50 text-xs mb-1">{t('output.stats.template')}</div>
          <div className="text-white font-semibold text-sm capitalize">
            {metadata.template || 'N/A'}
          </div>
        </div>
        <div className="glass-card p-3">
          <div className="text-white/50 text-xs mb-1">{t('output.stats.reduction')}</div>
          <div className="text-white font-semibold text-lg">
